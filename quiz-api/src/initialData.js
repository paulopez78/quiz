const data = `{
  ...
  "questions":[
    ...
    },
    {
      ...
      "options":[
        {"id":6,"correct":false,"name":"JQuery","result":0},
        {"id":5,"correct":true,"name":"Angular 2","result":0},
        {"id":4,"correct":false,"name":"XAML","result":0}
        ]},
      {
        "id":1,
        "name":"Who is the creator of React?",
        "options":[
          {"id":3,"correct":false,"name":"Twitter","result":0},
          {"id":2,"correct":false,"name":"Microsoft","result":0},
          {"id":1,"correct":true,"name":"Facebook","result":0}
          ]},
      {
        "id":7,
        "name":"What's the React strategy?",
        "options":[
          {"id":19,"correct":true,"name":"Put the HTML in JS","result":0},
          {"id":21,"correct":false,"name":"Put the CSS in HTML","result":0},
          {"id":20,"correct":false,"name":"Put the JS in HTML","result":0}
          ]},
      {
        "id":6,"name":"The state of a redux app should be always...",
        "options":[
          {"id":18,"correct":false,"name":"Hybrid","result":0},
